...
cd $MyWorkFolder
git add .\DevApp\*.TXT
git commit -m "auto commit DevApp $MyWorkFile"
git add .\DevApps\*.txt
git commit -m "auto commit DevApps $MyWorkFile"
git add .\Language\*.TXT
git commit -m "auto commit Language $MyWorkFile"
git add .\Fobs\*.zip
git commit -m "auto commit FOB objects $MyWorkFile"
